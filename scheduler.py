...
time_limit = 500  
print(f"Total time from all inputs: {total_time}")

if total_time > time_limit:
    print(f"Total time exceeds time limit. Current time: {total_time}. Machine Stop Process.")
else:
    print(f"Total time is within the limit: {total_time}")
...
# While each machine has not yet reached the time limit
